...
! function($) {
    ...
    BootstrapTable.prototype.initToolbar = function() {
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button id="%s" class="btn btn-default" type="button" name="refresh" title="%s">',
                    this.options.refresh, this.options.formatRefresh()),
        ...
        if (this.options.showToggle) {
            /* html.push(sprintf('<button class="btn btn-default" type="button" name="toggle" title="%s">',
                ...
                '</button>');
				console.log("???????: " + this.options.add); */
            if (this.options.add != null) {
                html.push('<button id="' + this.options.add + '" class="pull-right btn btn-default" type="button" name="' + this.options.add + '" title="Add">',
                    '<i class="glyphicon glyphicon glyphicon-plus icon-plus"></i>',
                    '</button>');
            }
        }
            ...
            $.each(this.header.fields, function(j, field) {
                ...
                if (that.options.columns[j].checkbox || that.options.columns[j].radio) {
                    ...
                    text = ['<td class="bs-checkbox">',
                        ...
                        sprintf(' type="%s"', type) +
                        sprintf(' value="%s"', item[field]) + //item[that.options.idField]) +
    ...
    BootstrapTable.prototype.initServer = function(silent) {
        ...
        console.log("dtype:: " + this.options.dtype);
        ...
        if (this.options.action == 'show_users') {
            data["action"] = this.options.action;
            data["email"] = localStorage.getItem("email");
            data["token"] = localStorage.getItem("token");
            data["type"] = this.options.dtype;
            //console.log("data:: " + JSON.stringify(data));
        }

        if (this.options.action == 'show_properties') {
            data["action"] = this.options.action;
            data["email"] = localStorage.getItem("email");
            data["token"] = localStorage.getItem("token");
            //data["type"]   = this.options.dtype;
            //console.log("data::show_properties:: " + JSON.stringify(data));
        }

        if (this.options.action == 'show_roomtypes') {
            data["action"] = this.options.action;
            data["email"] = localStorage.getItem("email");
            data["token"] = localStorage.getItem("token");
            data["propertyID"] = this.options.property;
            //data["type"]   = this.options.dtype;
            //console.log("data::this.options.propertyID:: " + this.options.property);
            //console.log("data::this.options.action:: " + this.options.action);
            //console.log("data::show_roomtypes:: " + JSON.stringify(data));
        }

        if (this.options.action == 'show_roomtypes_all') {
            data["action"] = this.options.action;
            data["email"] = localStorage.getItem("email");
            data["token"] = localStorage.getItem("token");
            //data["propertyID"] = this.options.property;
            ...
            //console.log("data::this.options.propertyID:: " + this.options.property);
            //console.log("data::this.options.action:: " + this.options.action);
            //console.log("data::show_roomtypes_all:: " + JSON.stringify(data));
        }

        if (this.options.action == 'show_roomtype_rooms') {
            data["action"] = this.options.action;
            data["email"] = localStorage.getItem("email");
            data["token"] = localStorage.getItem("token");
            data["roomtypeID"] = this.options.roomtype;
            //data["type"]   = this.options.dtype;
            //console.log("data::this.options.roomtypeID:: " + this.options.roomtype);
            //console.log("data::this.options.action:: " + this.options.action);
            //console.log("data::show_roomtypes_all:: " + JSON.stringify(data));
        }

        if (this.options.action == 'show_property_bookings') {
            data["action"] = this.options.action;
            data["email"] = localStorage.getItem("email");
            data["token"] = localStorage.getItem("token");
            data["propertyID"] = this.options.propertyid;
        ...
        if (this.options.action == 'show_checkin') {
            data["action"] = this.options.action;
            data["email"] = localStorage.getItem("email");
            data["token"] = localStorage.getItem("token");
            data["propertyID"] = this.options.propertyid;
            data["check_date"] = this.options.check_date;
        }

        if (this.options.action == 'show_checkout') {
            data["action"] = this.options.action;
            data["email"] = localStorage.getItem("email");
            data["token"] = localStorage.getItem("token");
            data["propertyID"] = this.options.propertyid;
        ...
        $.ajax({
            ...
            success: function(res) {
                //console.log("res.data.properties:: " + JSON.stringify(res.data));
            ...
            error: function(res) {
                //console.log("res.data.properties::error:: " + JSON.stringify(res.status));
    ...
    $(function() {
        $('[data-toggle="roomsTbl"]').bootstrapTable();

        $('[data-toggle="properties"]').bootstrapTable({
            contextMenu: '#context-menu',
            contextMenuTrigger: 'both',
            onClickRow: function(row, $el) {
                $('#myTable').find('.success').removeClass('success');
                $el.addClass('success');
            },
            onContextMenuItem: function(row, $el) {
                if ($el.data("item") == "edit") {
                    //alert("Edit: " + row.propertyID + ' ' + row.property_name + ' ' + serviceURL);
                    editProperty(row.propertyID);
                } else if ($el.data("item") == "delete") {
                    //alert("Delete: " + row.propertyID + ' ' + row.property_name);
                    deleteProperty(row.propertyID);
                } else if ($el.data("item") == "images") {
                    //alert("View: " + row.propertyID + ' ' + row.property_name);
                    //viewProperty(row.propertyID);
                    $("#fileupload").show();
                } else if ($el.data("item") == "roomTypes") {
                    //alert("View: " + row.propertyID + ' ' + row.property_name);
                    hideAll();
                    roomTypesList(row.propertyID, row.property_name);
                } else if ($el.data("item") == "services") {
                    //alert("View: " + row.propertyID + ' ' + row.property_name);
                    viewProperty(row.propertyID);
                }
            }
        ...
        $('[data-toggle="roomTypes"]').bootstrapTable({
            ...
            onContextMenuItem: function(row, $el) {
                if ($el.data("item") == "edit") {
                    ...
                    roomAvailability(row.propertyID);
                }
            }
        });
