...
<body>
				...
				<a class="navbar-brand" href="#">
					<?php
						...
						if (!file_exists($logo_image)) {
							$logo_image = "../../hotelier/img/roomier-w.png";
						}
					?>
	...
	<div id="shCheckAvailForm" class="row">
		<!-- <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4"> -->
			...
			<div class="booking-panel panel panel-default">
				<div id="bookingPanel">
					<div class="panel-heading text-center"><?php echo $lang['CHECK_AVAILABILITY_TITLE']; ?></div>
					<div class="panel-body">
						<fieldset>
							<div class="row">
							</div>
							...
							<div class="row">
								...
								<div class="col-md-4">
									<button id="addGuests" class="btn btn-info gmremovebutstyle" type="button" name="addGuests" title="add Guests">
										<i class="glyphicon glyphicon glyphicon-plus icon-plus"></i>&nbsp;<?php echo $lang['ADD_ROOM']; ?>
									</button>
									<br/><br/>
								</div>
								<div class="col-md-4">
									<button class="btn btn-primary gmfullwidth"  id="booking-form-check" name="booking-form-check">
										<?php echo $lang['CHOOSE_ROOMS_AND_RATES']; ?>
									</button>
								</div>
    ...
    <div class="rmchnglnks">
        <div class="container">
            <div class="row">
                <ul>
                    <li> <a href="#">Ακύρωση / Αλλαγή Κράτησης </a> </li>
                    <li> <a href="#"> Επιστροφή στη σελίδα του ξενοδοχείου</li> </a>
                </ul>
            </div>           
        </div>
    </div>    
      ...
      <div class="container">
          ...
          <div class="row">
  <div class="col-md-4">
      <p class="copyrights">Powered By:</p>
      <a href="http://www.roomier.gr"> <img class="gmfooterlogo" src="http://booking.roomier.gr/hotelier/img/roomier-w.png"/></a>
              </div>
