        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            $.each(this.header.fields, function (j, field) {
				...
				if(field == 'background') {
					...
					var image = new Image(); 
					image.src = serviceURL+"uploads/files/backgrounds/background_"+item['propertyID']+".png";	
					var path =  serviceURL+"uploads/files/backgrounds/background_"+item['propertyID']+".png";	
					if (image.width == 0) {
						console.log("image is missing:: " + image.src);
						path = '#';
					}
					value = '<input type="button" data-property="' + item['propertyID'] + '" class="backGroundUpload" value="upload background"><br/>'
					           +'<a href="' + path + '" targe="_blank">Preview</a>';
				}
    ...
    BootstrapTable.prototype.initServer = function (silent) {
        ...
        $.ajax({
            ...
            success: function (res) {
				//console.log("res.data.users:: " + JSON.stringify(res.data));
